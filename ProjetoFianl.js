...
function imprimirMenu() {
	...
	console.log('(4) Mutiplicação escalonar.')
...
basta repetir as duas primeiras colunas
à direita do determinante e mutiplicar os elementos do determinante da seguinte*/
...
Normalmente, é utilizado quando as matrizes são de ordem igual ou superior a 4.*/
...
os elementos de C subtrair os elementos correspondentes de A e B */
contador = 1
matriz1 = []
matriz2 = []
r1 = []
